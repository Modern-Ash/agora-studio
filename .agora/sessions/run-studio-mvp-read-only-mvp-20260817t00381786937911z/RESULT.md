...
session: "run-studio-mvp-read-only-mvp-20260817t00381786937911z"
status: "completed"
exit-code: 0
output-bytes: 62517
...
# Session result run-studio-mvp-read-only-mvp-20260817t00381786937911z
...
## Standard error
    ...
    session id: 01a00d27-e01d-7100-b61d-e42fc0199e32
    --------
    user
    ...
    [
      {
        ...
        "blockers": [
          "Session run-studio-mvp-read-only-mvp-20260817t00381786937911z is already running"
        ],
        "session_id": "run-studio-mvp-read-only-mvp-20260817t00381786937911z",
